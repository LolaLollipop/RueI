namespace RueI
{
    ...
    public class OldParser
    {
        ...
        public ParsedData Parse(string text)
        {
            ...
            {
                return new(currentHeight, currentLineWidth, size, newOffset, currentCSpace, shouldParse, isMonospace, isBold, currentCase, sizeStack, colorTags);
            }

            void LoadContext(ParserContext context)
            {
                (currentHeight, currentLineWidth, size, newOffset, currentCSpace, shouldParse, isMonospace, isBold, currentCase, sizeStack, colorTags) = context;
            }
